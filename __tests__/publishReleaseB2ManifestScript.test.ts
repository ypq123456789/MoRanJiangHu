...
describe('B2 release publish manifest script', () => {
    ...
    it('keeps the publish script wired to GitHub-first manifests while B2 can be skipped', () => {
        ...
        expect(source).toContain('b2ApkUrl: \'\',');
        expect(source).toContain('b2DirectApkUrl: \'\',');
